...
CREATE TABLE identity.studies (
    ...
    require_approval_to_join boolean DEFAULT true NOT NULL,
...
COPY billing.plan_features (id, plan_id, feature_id, feature_name) FROM stdin;
\.
...
COPY identity.plan_features (id, plan_id, feature_id, feature_name) FROM stdin;
\.
...
COPY identity.studies (id, owner_id, title, description, research_field, status, allow_public_comments, allow_data_download, require_approval_to_join, views_count, stars_count, institution, principal_investigator, is_featured, tags, created_at, created_by, modified_at, modified_by, is_deleted, deleted_at, deleted_by) FROM stdin;
\.
...
COPY plans.plan_features (id, plan_id, feature_id, feature_name) FROM stdin;
...
COPY studies.studies (id, owner_id, title, description, research_field, status, allow_public_comments, allow_data_download, require_approval_to_join, views_count, stars_count, institution, principal_investigator, is_featured, tags, created_at, created_by, modified_at, modified_by, is_deleted, deleted_at, deleted_by) FROM stdin;
