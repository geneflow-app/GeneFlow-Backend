...
public class SubscriptionTests
{
    ...
    [Fact]
    public void Expire_ShouldSetExpiredStatus()
    {
        // Arrange
        var subscription = CreateTestSubscription();
    ...
    [Fact]
    public void Expire_ShouldRaiseSubscriptionExpiredEvent()
    {
        // Arrange
        var subscription = CreateTestSubscription();
        subscription.ClearDomainEvents();
    ...
    [Fact]
    public void Expire_ShouldSetModifiedAt()
    {
        // Arrange
        var subscription = CreateTestSubscription();
    ...
    [Fact]
    public void Expire_WhenCancelled_ShouldStillExpire()
    {
        // Arrange
        var subscription = CreateTestSubscription();
        subscription.Cancel();
    ...
    [Fact]
    public void Expire_GrantsAccess_ShouldBeFalse()
    {
        // Arrange
        var subscription = CreateTestSubscription();
