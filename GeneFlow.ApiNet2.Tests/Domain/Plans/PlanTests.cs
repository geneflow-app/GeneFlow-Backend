...
public class PlanTests
{
    ...
    [Fact]
    public void AddFeature_ShouldAddFeature()
    {
        // Arrange
        var plan = CreateTestPlan();
    ...
    [Fact]
    public void AddFeature_WhenAlreadyExists_ShouldReturnFailure()
    {
        // Arrange
        var plan = CreateTestPlan();
    ...
    [Fact]
    public void RemoveFeature_ShouldRemoveFeature()
    {
        // Arrange
        var plan = CreateTestPlan();
        plan.AddFeature(PlanFeature.CopilotAccess);
    ...
    [Fact]
    public void RemoveFeature_WhenNotExists_ShouldReturnFailure()
    {
        // Arrange
        var plan = CreateTestPlan();
    ...
    [Fact]
    public void HasFeature_WhenFeatureNotExists_ShouldReturnFalse()
    {
        // Arrange
        var plan = CreateTestPlan();
