...
public class StudyTests
{
    ...
    [Fact]
    public void Feature_ByAdmin_ShouldSetFeatured()
    {
        // Arrange
        var ownerId = CreateUserId();
        var study = Study.Create(
    ...
    [Fact]
    public void Feature_ShouldRaiseStudyFeaturedEvent()
    {
        // Arrange
        var ownerId = CreateUserId();
        var study = Study.Create(
    ...
    [Fact]
    public void Feature_ByNonAdmin_ShouldReturnFailure()
    {
        // Arrange
        var ownerId = CreateUserId();
        var study = Study.Create(
    ...
    [Fact]
    public void Feature_AlreadyFeatured_ShouldReturnFailure()
    {
        // Arrange
        var ownerId = CreateUserId();
        var study = Study.Create(
    ...
    [Fact]
    public void Unfeature_ShouldClearFeatured()
    {
        // Arrange
        var ownerId = CreateUserId();
        var study = Study.Create(
